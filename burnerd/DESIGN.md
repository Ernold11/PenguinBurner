...
- `ExecStart=/usr/libexec/penguin-burnerd`. The elevated installer atomically
  stages wheel/dev bytes there first; the root unit never executes a
  user-writable package or checkout path.
