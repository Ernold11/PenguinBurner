    ...
    try:
        ...
        _log_user_stage(
            ...
            [
                ...
                f"This measures the real base sustained clock, voltage, power, temperature, and fan speed for about {AUTO_UV_DEFAULTS.probe_duration_s}s before undervolting.",
