...
old Auto-UV package surface, keeps Balanced and Efficiency focused on the
undervolt pass, and adds the Performance Auto-OC pass as separate backend logic.

### Highlights

- Auto-UV internals now live under `auto_uv`; stale tracked files are removed
  from the package.
...
PenguinBurner 0.1.8 cleans up Auto-UV internals, removes stale tracked files,
adds a separate Performance Auto-OC pass after balanced undervolting, and
