...
class EfficiencyPolicyRules:
    min_fps_per_w_gain_pct: float = 0.5
...
def decide_efficiency_stop(
    *,
    ...
    if not bool(budget_spent_or_disabled):
        return EfficiencyStopDecision(False, confirmations, False, "budget still available")
