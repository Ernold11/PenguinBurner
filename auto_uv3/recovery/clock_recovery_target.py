"""Convert clock-recovery budget into a concrete target MHz on the base curve grid.

This keeps performance recovery deterministic and bounded by the measured baseline/cap rules.
"""
