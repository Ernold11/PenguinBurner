"""Apply one candidate curve and run the strict Q2RTX/CUDA probe.

This module owns live execution only; pass/fail interpretation stays in probe_stability_decision.py.
"""
