"""Choose Q2RTX and CUDA probe durations for each voltage band.

Lower voltages get longer probes and always add the CUDA companion workload for real stability checks.
"""
