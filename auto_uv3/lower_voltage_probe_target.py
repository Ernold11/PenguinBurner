"""Choose the clock target for the next lower-voltage probe before it runs.

The default target follows the base curve downward; recovery budget can raise it later.
"""
