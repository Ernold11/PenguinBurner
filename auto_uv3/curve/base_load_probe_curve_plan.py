"""Turn first base-load probe evidence into the first flattened V/F curve.

This module connects target-frequency selection to curve flattening; it does not run Q2RTX.
"""
