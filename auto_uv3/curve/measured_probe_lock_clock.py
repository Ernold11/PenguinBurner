"""Convert measured loaded probe clock back into the lock clock Auto-UV should use.

Loaded clocks are snapped down to the base-curve step so a flattened curve does not chase boost noise.
"""
