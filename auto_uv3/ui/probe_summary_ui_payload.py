"""Convert one Q2RTX/CUDA probe summary into the UI table payload.

The payload keeps raw average metrics visible while the stability module explains pass/fail.
"""
