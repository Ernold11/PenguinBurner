...
from auto_uv3.recovery.clock_recovery_budget import next_recovery_budget_used_pct
from auto_uv3.recovery.clock_recovery_target import choose_clock_recovery_target_mhz
from auto_uv3.scan_mode.efficiency_fps_per_w_policy import (
    compare_temperature_normalized_fps_per_w,
    decide_efficiency_stop,
)
from auto_uv3.scan_mode.performance_fps_score_policy import performance_score_from_values
from auto_uv3_test_data import probe_summary, wide_base_curve
